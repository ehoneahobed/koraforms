...
- Accepted public responses update `forms.responseCount` with `op.increment(1)` through `req.kora.apply()`, keeping dashboard counters race-safe under concurrent submissions.
