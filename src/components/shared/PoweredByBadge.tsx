...
export function PoweredByBadge({ slug, variant = 'subtle' }: Props) {
	...
	if (variant === 'prominent') {
		return (
			...
			>
				<img src="/logo-icon-sm.png" alt="" width={16} height={16} className="w-4 h-4 rounded-sm shrink-0" />
	...
	return (
		...
		>
			<img src="/logo-icon-sm.png" alt="" width={12} height={12} className="w-3 h-3 rounded-sm shrink-0 opacity-50" />
			Made with KoraForms
		</a>
	)
}
